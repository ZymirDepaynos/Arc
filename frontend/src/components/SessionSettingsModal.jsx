...
import { X, Timer, Check, Database, Download } from "lucide-react";
...
export default function SessionSettingsModal({ open, onClose, onUpdate }) {
  ...
  const handleCustomSubmit = () => {
    ...
    if (isNaN(val) || val < 1) {
      toast.error(
        `Enter at least 1 ${customUnit === "hours" ? "hour" : "minute"}`,
      );
      return;
    }
      ...
      {open && (
        ...
        >
          ...
          >
                    ...
                    style={{
                      ...
                      background:
                        customUnit === "minutes"
                          ...
                          : "transparent",
                      color:
                        customUnit === "minutes" ? "#fff" : "var(--text-muted)",
                    ...
                    style={{
                      ...
                      background:
                        customUnit === "hours"
                          ...
                          : "transparent",
                      color:
                        customUnit === "hours" ? "#fff" : "var(--text-muted)",
                      transition: "all 0.15s ease",
                    }}
                  >
                    Hr
            ...
            >
              This setting is saved to your account and persists across all
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: 11, color: "var(--text-muted)", margin: 0, marginTop: 2 }}>
                    Download a secure local copy of your database.
                  </p>
                </div>
              </div>
              <button
                onClick={() => {
                  window.open(`${import.meta.env.VITE_API_URL || ''}/api/settings/export/database`, '_blank');
