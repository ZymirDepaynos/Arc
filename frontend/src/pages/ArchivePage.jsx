...
export default function ArchivePage() {
  ...
  const handleRestore = async () => {
    ...
    try {
      await toast.promise(
        ...
        {
          loading: "Restoring...",
          success: `${restoreTarget.name} restored!`,
  ...
  const handlePermDelete = async () => {
    ...
    try {
      await toast.promise(api.delete(`/api/archive/${deleteTarget.id}`), {
        loading: "Deleting...",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <div>
                ...
                >
                  {records.length} archived record
                  {records.length !== 1 ? "s" : ""}
                </p>
              </div>
            </div>
                  ...
                  {filtered.map((record, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          {record.original_debt > 0 ? (
                            fmt(record.original_debt)
                          ) : (
